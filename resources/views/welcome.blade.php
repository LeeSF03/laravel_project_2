...
<head>
    ...
    <title>{{ config('app.name', 'LeeSF.COM') }}</title>
...
<body class="h-100 p-3">
    <div class="d-flex w-100 border-bottom border-dark mx-2 px-5 pb-3">
        <div class="w-100">
            ...
            <div class="w-100 d-flex justify-content-end align-items-center">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="text-dark mx-2">Register</a>
                    @endif
                @endauth
            </div>
        @endif
    ...
    <div class="h-75 row align-items-center d-flex justify-content-center">
        <div class="" id="wlc-root">
